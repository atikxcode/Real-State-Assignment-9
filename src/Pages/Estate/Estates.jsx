...
const Estates = ({property}) => {
  ...
  return (
    <div className=" p-4 bg-cover bg-center w-[450px] h-[400px] relative group rounded-lg " data-aos="fade-up" data-aos-duration="2000"  style={{backgroundImage: `url(${estate_image})`}}>
